...
- The **signed build** is sold. €14.99, one price, every 1.x release, every Mac you own.
...
€14.99. One price, one major version, every Mac you own or control. No
subscription, no seats, no activation count.
