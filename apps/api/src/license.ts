...
// apps/apple/Bastion/License.swift runs inside a binary that is forbidden from
...
// test/license.test.ts asserts the two produce identical bytes.

const KEY_PREFIX = "bas1";
